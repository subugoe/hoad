...
Built by: <a href= "https://www.sub.uni-goettingen.de/sub-aktuell/"><img src="img/sub_logo.svg" width="200"  alt="SUB Göttingen"></a>.
...
renderPlotly({
  p <- hybrid_df %>%
    ...
    xlab("Year") +
    ylab("Articles") +
    scale_x_discrete(limits = factor(c(2013:2019))) +
    scale_y_continuous(
      labels = function(x)
        format(x, big.mark = " ", scientific = FALSE),
