...
renderPlotly({
  p <- ggplot(hybrid_sub(), aes(year, prop, fill = license)) +
   ...
   # pallette https://twitter.com/debivort/status/994583058031546369
    scale_fill_manual("License", values =  c("#65BADA", "#068E8C", "#00A757", "#E5BA52", "#D86F27", "#C82E6B")) +
...
### Disclosure of Institutional Sponsorship for OA Publication
...
renderPlotly({
  ...
  p <-
    ...
    ylab("Articles") +
    scale_x_discrete(drop = FALSE) +
    scale_fill_manual("", values = c("#23445D", "#AE4132", "#12AAB5")) + 
    scale_y_continuous(
      labels = function(x)
