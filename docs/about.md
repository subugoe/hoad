...
[This open source dashboard](https://najkoja.shinyapps.io/hybridoa/) presents the uptake of hybrid open access for 3,434 different journals from 44 publishers between 2013 - 2018. During this six years period, 121,781 articles were made openly available immediately in these subscription-based journals, representing 2.6% of the total article volume studied.
...
Using data from Open APC and Crossref, we found 121,781  open access articles published in
3,434 subscription-based journals from 44 publishers between 2013 - 2018. These articles accounted for about 2.6% of the overall journal article volume investigated.
