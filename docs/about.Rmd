...
Hybrid open access journal publishing is at the center of recent debates about implementing open access. Research funders and organisations as well as academic libraries demand evidence about the extent of open access articles published in subscription-based journals to develop and revise their open access policies. While research funders in the UK and the European Commission has widely sponsored individual open access publication in toll-access journals, others refrain from it. For instances, university-wide publication funds in Germany, many of which have been supported by Deutsche Forschungsgeemeinschaft, do not cover publication fees when researchers wish to publish in hybrid open access journals. 

Against the background of varying policies about hybrid open access journal publishing, the OA 2020 initiative called for an aligned large-scale transition from subscription to open access business models. Transformative agreements has been proposed as one mean to re-allocate budgets used for subscriptions in favor of open access business models. Because the total cost  

like University-wide publication funds Publication Funds in Germany did not.  

Determining whether and to what extent hybrid open access has developed is relevant for assessing recent open access policies providing or refusing support publication fees that may arise for publishing in these journals. While research funders in the UK and the European Commission widely funded individual open access publication ins subcription-based journals, others like Publication Funds in Germany did not. 
