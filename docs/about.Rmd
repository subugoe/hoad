...
These developments show that open and standardized reporting is critical to monitor hybrid open access publishing. Against this background, we developed an methodology for investigating the uptake of hybrid open access, taking into account journals with the following two characteristics:
...
In the lower part of the dashboard page "Overview", the left-hand graph shows the extent to which information about open access funding was available.  On the right, an overview about the first respective corresponding author email's top and lower-level domain is presented according to the publisher and journal selection.
...
q <- ggplot(my_df, aes(publisher_group, prop)) + 
  ...
  labs(y = "Hybrid OA share per journal in 2017 - 2018", x = "Publishers (Top 3)",
       title = "What was the share of immediate open access articles \nin subscription-based journals in the two-years period 2017 - 2018?") +
  theme_minimal(base_family = "Roboto")  +
  theme(plot.margin=margin(30,30,30,30)) +
  theme(panel.grid.minor=element_blank()) +
  theme(axis.ticks=element_blank()) +
...
This dashboard demonstrates the uptake of hybrid open access publishing for a sample of subscription-based journals where institutional support facilitated the open access publication of individual articles, and where licensing metadata about the open access status were made available through Crossref. By operationalizing policy recommendations and funding criteria, particularly the ESAC Guidelines for Transformative Agreements, our approach not only shows how hybrid open access can be monitored using open data and tools. Moreover, it extends bibliometric methods on identifying journals that already provided paid open access to individual articles, as well as on distinguishing immediate from delayed open access provision at the article-level.

The presented longitudinal findings are consistent with earlier studies, confirming the growth of hybrid open access publishing. @Bj_rk_2012 observed a slow, but steady rise of hybrid open access. The author estimated that 12,000 articles were made openly available under this model in 2012. Studying the development of hybrid open access publishing between 2007 - 2013, @Laakso_2016 observed an increase at the journal and at the article-level. The authors determined 13,994 hybrid open access articles published in 2,714 different journals during 2013. Around 40% of journals offering options to make individual articles openly available upon publication did publish at least one article under this model in 2013. In a follow-up study, @Bj_rk_2017 noticed an accelerated growth of articles since 2014, whereby 20 major publishers published around 44,395 hybrid open access articles in 2016. According to this study, an increasing willingness to fund publication fees, in particular among Austrian and British research funders and universities, likely influenced this strong uptake on the one hand; on the other hand, more and more national consortia and large research institutions have begun to successfully negotiate central agreements with publishers.

Combining publication and spending data, the impact of these developments in recent years becomes evident. Our findings indicate that UK-based corresponding authors were responsible for around every fifth hybrid open access article in our sample, presumably because of the comprehensive funding activities in the course of the Finch report in 2012 [@Pinfield_2015]. Austria, where the Austrian Science Fund (FWF) has financed hybrid open access publication fees since many years [@fwf_apc_13], was well represented among the top countries in terms of hybrid open access articles published. Moreover, it can be observed that growth in hybrid open access uptake has been strongly driven by transformative agreements since 2015. Most notably, Springer Nature, who already had been among the first with an aligned portfolio of hybrid open access journals, has offered the Springer Compact agreement to selected national consortia and large research organizations since then [@Laakso_Solomom_2016; @Geschuhn_2017]. Consequently, authors affiliated with countries where these agreements were in place, including the UK, the Netherlands, Sweden and Austria, ranked among the top in terms of published hybrid open access articles. Likewise, Springer Nature not only published the largest volume of hybrid open access journals and articles, but also had an above-average uptake in the last years. On average, 12 % of articles in subscription-based journals provided by Springer Nature in the two-years period 2017-2018 were made openly available without delay. In contrast, the journal portfolio of Elsevier, a publisher reported as being reluctant to transformative agreements [@Else_Elsevier_2018], has a lower open access uptake according to our data. 

Although our findings confirm the uptake of hybrid open access and variations among countries and publishers in recent years, related studies observed higher proportions of freely available articles in hybrid open access journals. Studying subscription-based journals with at least one identified hybrid open access article as well, @Laakso_2016 determined an open access share of 3.8 % for the period of 2011–2013. @Piwowar_2017, estimated an even higher proportion according to which 9.4 % of articles published in 2015 were provided open access with license statements, with or without delay, by non-DOAJ indexed journals. 

The journal selection criteria used in the dashboard has some limitations that likely yield to these comparatively lower estimates. Only one out of three publishers, where a research institution or a funder has demonstrably sponsored a hybrid open access article, shared licensing metadata through Crossref as suggested by initiatives like [ESAC](http://esac-initiative.org/). Particularly, smaller publishing houses were not well represented in the sample. Similarly, @Piwowar_2017 found that Crossref lacks some license coverage. Therefore, they investigated publisher websites for license statements as well. Furthermore, @Piwowar_2017 observed that the percentage of open access provided by publishers, which was free to read, but where the journal was neither listed in the DOAJ nor provided licensing metadata, was the most common method to provide open access among publishers. 

In addition to this observed incomplete licensing coverage, our findings also suggest a gap between spending information available through the Open APC initiative and the total number of hybrid open access articles that have been registered with Crossref in recent years. One reason is that reporting to the Open APC initiative is voluntary [@Jahn_2016]; another that despite its international focus, most spending information was collected from European institutions, in particular from the UK [@Pieper_2018]. However, the analysis of email domains from corresponding authors, who published hybrid open access articles, revealed that affiliations from the US, Germany and Japan ranked in the top 10. Because of lacking spending data, it remains open to speculation whether authors from these institutions made use of institutional support not tracked by the Open APC initiative, or used other budgets. Publication fees could also be waived [@Solomon_2011], or articles were made open for promotional reasons [@Laakso_2016]. With a strong focus on Springer Nature, Open APC Initiative has started to disclose articles from transformative agreements as well. Nevertheless, as the example of the Sponsoring Consortium for Open Access Publishing in Particle Physic -- SCOAP$^3$ demonstrates, consortia also make use of repositories to disclose hybrid open access articles they sponsored, which are not yet tracked by Open APC.

An obvious direction for future work is to expand the evidence-base about hybrid open access journals. One possible route is to start with journal lists from publishers. Example for bibliometric studies approaching such lists to identify hybrid open access journals include @Laakso_2016 and @Matthias_2019b. Both works, however, note that searching and compiling such lists were very laborious, because data needed to be retrieved from heterogeneous spreadsheets that were made available on publisher websites. They therefore focused on major publishers only. In the course of the Plan S consultation, the ESAC Initiative has launched another potential source of data. Its [Registry of Transformative Agreements](https://esac-initiative.org/about/transformative-agreements/agreement-registry/) collects essential information about these contracts. So far, 44 contracts were disclosed and linked. Some of those contracts yield information about journals under transformative agreements, making it a promising data source to study the impact of such transitional mechanism in general, and the compliance of the implemented metadata workflows in particular.

Another strand for future research is to match open access discovery solutions that contain information about hybrid open access articles with major bibliometric databases. @Akbaritabar_2019 identified hybrid and delayed open access articles from Crossref for articles indexed in the Web of Science and Scopus inhouse-databases maintained by the German Competence Centre for Bibliometrics. They also contrasted open access status information derived from Crossref license statements with Unpaywall. Such an approach not only allows for cross-validation. Bibliometric databases also complement the evolving openly available evidence-base around hybrid open access with information about affiliation, funding and journal subjects. Particularly, the overall market share of publishers across countries and subjects needs more careful consideration when interpreting the results. Is the hybrid open access market dominated by a few countries and big publishers? Or were they more likely to succeed in their attempts to implement open and transparent workflows? What is the impact of hybrid open access publishing in general, and transformative agreements in particular, on the transition of institutional and subject-specific publication practices towards open access? And do these activities contribute to journal flipping from a subscription-based model to fully open access? 

In the light of recent policy developments following OA 2020 and the Plan S, the overall aim of this dashboard is to promote evolving standards and infrastructures for analyzing the transition of subscription-based journal publishing to open access. Crossref provides excellent guidance for publishers to make licensing metadata available via the Crossref APIs:
<https://support.crossref.org/hc/en-us/articles/214572423-License-metadata-Access-Indicators->. For being best represented in this dashboard, publishers will have to make sure to include license URL element `license_ref` and a `start_date` equal to the date of publication in the licensing metadata, which helps to identify open access journal content as well as to differentiate between immediate and delayed open access. Likewise, research institutions, funders, and libraries can increase transparency about hybrid open access publishing including transformative agreements by reporting funded articles to the Open APC initiative on a regular basis. Both practices comply with [ESAC's recommendation for article workflows and services for offsetting/ open access transformation agreements](http://esac-initiative.org/its-the-workflows-stupid-what-is-required-to-make-offsettin). As this dashboard demonstrates, following these guidelines will help to extend existing methods and data sources to investigate the transition of subscription-based journal publishing to open access in an open and transparent way.
