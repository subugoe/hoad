...
The page "Overview" presents data visualization allowing to explore variations hybrid open access publishing across publishers. It focuses on market shares in terms of the absoluter number of published articles and the hybrid open access share among journals across publishers. A table at the bottom of the page presents these key indicators at the journal-level, which can be downloaded as Excel spreadsheet.
