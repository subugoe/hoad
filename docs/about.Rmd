...
These developments show that open and standardized reporting is critical to monitor hybrid open access publishing. Against this background, we investigated the uptake of hybrid open access publishing for journals sharing the following two characteristics:
