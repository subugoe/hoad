...
Along with the discoverability of hybrid open access articles, there is also considerable debate about the revenue sources of this publishing model. In addition to subscriptions, hybrid open access journals often charge publication fees, also known as article processing charges (APC), to provide immediate open access to individual articles [@Suber_2012]. Although initially envisioned that with growing funding opportunities for publication fees publishers will convert journals to open access [@Prosser_2003], it remains unclear to which extent the willingness to pay for open access contributed to the transition of subscription-based journals, and how cost-effective they were [@Bj_rk_2014; @Pinfield_2017]. 

The [Open Access 2020 Initiative](https://oa2020.org/) has taken up the problem of missing evidence, demanding a data-driven discussion about converting budgets spent for subscriptions to open access business models. Likewise, funders and libraries have developed compliance criteria to improve reporting practices about hybrid open access publishing. In the US, for example, Chorus, a non-profit serving more than 50 publishers, uses freely available  metadata from Crossref, a DOI registration agency for scholarly works, to presents open access compliance for dedicated funders with [interactive dashboards](https://dashboard.chorusaccess.org/). In Europe, the Wellcome Trust has made expenditures for open access publications openly available [@Kiley_2015]. The funder also [automatically checks](https://compliance.cottagelabs.com/docs) if authors and publishers comply with a comprehensive set of metadata obligations. Other European research funders and research-performing institutions including the Austrian Science Fund FWF and British Universities also disclosed spendings for open access articles in hybrid open access journals [@fwf_apc_13; @jisc_14]. The [Open APC Initiative](https://github.com/openapc/openapc-de) collected and standardized these data reports together with self-reported expenditures [@Pieper_2018]. When merging various cost datasets, curation issues can be addressed using metadata from Crossref [@Jahn_2016]. 

Most recently, the cOAlition S, a network of 11 research funders, released its widely discussed Plan S. Starting from 2020, members of the cOAlition S only wants to fund hybrid open access articles under a transformative agreement, in which subscription and open access publication are considered together. The Plan S implementation guidelines also require a commitment to full open access transition from the publishers, and refer to the [ESAC Initiative](http://esac-initiative.org/), based at the German Max Planck Digital Library (MPDL), to observe these contracts. ESAC focuses on standardizing open access workflows between publishers and libraries. For this aim, the initiative released guidance about how to implement transformative agreements. These guidelines expect publishers to provide rich metadata to Crossref including open access license information, as well as to report covered articles to libraries [@Geschuhn_2017]. Some library consortia like the Swedish Bibsam or the British Jisc have started to make these reports openly available with the Open APC Initiative to increase the transparency of transformative agreements [@Lund_n_2018]. 

These developments show that rich and open data about hybrid open access publishing are critical to assessing this publishing model. To encourage good data practices when monitoring the transition of subscription-based journals to open access, we built this analytical dashboard where a hybrid open access journal must have the following characteristics to become included:
