...
1. academic institutions sponsored the publication fee or enabled open access publication through an transformative agreement according to the [Open APC initiative](https://github.com/openapc/openapc-de),
...
Our methods follow the Wickham-Grolemund approach to practice data science [@Wickham_2017]. After importing and merging ("tidying") data from various sources, summary statistics were calculated and visualized to understand and communicate the uptake of hybrid open access publishing. For the latter, we created an interactive dashboard. Our workflow, illustrated in Figure and described in this section, was implemented in R using open data and tools, making it transparent and re-usable. 
