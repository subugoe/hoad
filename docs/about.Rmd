...
2. Publishers provided open content license statements via [Crossref](https://www.crossref.org/) including information about whether articles were made openly available <!--directly -->upon publication or not.
...
1. Academic institution sponsored immediate open access publication of individual articles according to the Open APC initiative,
2. Publisher provided open content license statements via Crossref including information about whether articles were made openly available upon publication or not.
...
title <- ggdraw() + draw_label("Hybrid Open Access Uptake 2013-2019", fontfamily = "Roboto")
p <- plot_grid(title, p_license, ncol=1, rel_heights=c(0.1, 1))
ggsave(p, path = "../img/", filename = "p_license.png", width = 9, height = 4.5, dpi = 450, device = "png")
```
...
q <- ggplot(my_df, aes(publisher_group, prop)) + 
  ...
  theme(panel.grid.major.y=element_blank()) +
  theme(panel.border=element_blank()) 
ggsave(q, path = "../img/", filename = "oa_variation.png", width = 9, height = 4.5, dpi = 450, device = "png")
```  
...
hybrid_cr %>%
  ...
  labs(x = "Year", y = "Hybrid OA Articles",
       title = "Availability of Spending Information for Hybrid Open Access Articles",
       subtitle = "Breakdown by top-level domain of email address from corresponding authors") +
  theme_minimal(base_family = "Roboto", base_size = 12) +
  theme(plot.margin=margin(30,30,30,30)) +
  theme(panel.grid.minor=element_blank()) +
  theme(axis.ticks=element_blank()) +
...
ggplot2::ggsave(plot_institutions, path = "../img/", filename = "plot_institutions.png", width = 9, height = 8, dpi = 450, device = "png")
```
