...
This dashboard demonstrates the uptake of hybrid open access publishing for a sample of subscription-based journals where institutional support facilitated the open access publication of individual articles, and where licensing metadata about the open access status were made available via Crossref. By operationalizing policy recommendations and funding criteria, particularly the ESAC guidelines for Transformative Agreements, our approach shows not only how hybrid open access can be monitored using open data and tools. Moreover, it extends existing methods in the empirical study of hybrid open access to identify journals that already provided paid open access to individual articles, and to distinguish immediate from delayed open access provision at the article-level.
