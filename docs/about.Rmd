...
This dashboard demonstrates the uptake of hybrid open access publishing for a sample of subscription-based journals where institutional support facilitated the open access publication of individual articles, and where licensing metadata about the open access status were made available through Crossref. By operationalizing policy recommendations and funding criteria, particularly the ESAC guidelines for Transformative Agreements, our approach not only shows how hybrid open access can be monitored using open data and tools. Moreover, it extends computational methods in the empirical study of hybrid open access on identifying journals that already provided paid open access to individual articles, as well as on distinguishing immediate from delayed open access provision at the article-level.

The presented longitudinal findings are consistent with earlier studies, confirming the growth of hybrid open access publishing. Accordingly, @Bj_rk_2012 observed a slow, but steady growth of  hybrid open access and estimated that 12,000 open access articles were published under this model in 2012. Studying the development of hybrid open access publishing between 2007 - 2013, @Laakso_2016 confirmed the increase at the journal and at the article-level. The authors identified 13,994 hybrid open access articles published in 2,714 different journals during 2013. Around 40% of journals offering options to make individual articles openly available upon publication did publish at least one article under this model in 2013. In a follow-up study, @Bj_rk_2017 observed an accelerated growth of articles since 2014, estimating 44,395 hybrid open access articles published by 20 major publishers.

The growth of hybrid open access can be explained by an increasing willingness to fund publication fees on the one hand; on the other hand, transformative agreements has become a widely discussed mechanism contributing to the increasing number of hybrid open access articles in the literature [@Bj_rk_2017]. In the case of individual publication fees, particularly funders from the Austria, the UK and the European Commission have been covering charges for hybrid open access in recent years, while the German Research Foundation (DFG) has supported institutional funds dedicated to fully open access journals only [@Bj_rk_2014; @Pinfield_2015; @Jahn_2016].  <!-- Our findings show that UK-based authors were responsible for around very fifth hybrid open access article that has been published since 2013.--> Combining publication and spending data, the impact of centralized agreements on the hybrid open access uptake with large publishers, notably Springer Nature, in recent year becomes apparent. The publisher has not only been among the first major publishers offering an aligned portfolio of hybrid open access journals, but also experimenting with central agreements for selected customers [@Laakso_Solomom_2016]. Particularly, the Springer Compact deal with some national consortia is well represented in our data. Overall, Springer Nature published the largest volume of hybrid open access articles in our sample. On average, 12 % of articles in subscription-based journals provided by Springer Nature were made openly available without delay. In contrast, the journal portfolio of Elsevier, reported as being reluctant to transformative agreements [@Else_Elsevier_2018], has a much lower open access share according to our data.

<!--presumably because of centralized agreements with large publishers. Notably Springer Nature has started to offer offsetting deals to large research organisations like the Max Planck Society and national consortia since then [@Geschuhn_2017]. But also recent funding policies in favor of hybrid open access, notably in the UK, likely influenced the uptake of hybrid open access publishing [@Pinfield_2017].-->
