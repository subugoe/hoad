...
In the lower part of the dashboard page "Overview" the left-hand graph shows the extent to which information about funding of open access publication was available. were. On the right, an overview about the first respective corresponding author's top and lower-level domains is presented according to the publisher and journal selection.
...
The page "Overview" presents data visualization allowing to explore how hybrid open access publishing varies across publishers. It focuses on market shares in terms of the absoluter number of published articles and differences in the share of hybrid open access articles among journals across publishers. A table at the bottom of the page presents these key indicators at the journal-level, which can be downloaded as Excel spreadsheet.
