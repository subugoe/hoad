...
In the light of the ongoing debate on the transition from subscription-based journal publishing to open access, this dashboard presents a steady, but varying uptake of hybrid open access. It takes advantage of an improved level of compliance with policy recommendations addressing open access discoverability and transparent workflows.

This dashboard presents the uptake of hybrid open access publishing. It investigates subscription-based journals where institutions sponsored the open access publication of at least one article. To become included, these journals must furthermore state open content licenses through Crossref. This approach, which operationalizes policy recommendations, particularly the ESAC Guidelines for Transformative Agreements, not only shows how to monitor hybrid open access using open data and tools. Moreover, it extends bibliometric methods in two ways: First, the study identifies subscription-based journals that already provided paid open access to individual articles. Second, it distinguishes whether these journals made articles freely available with or without delay.
