...
For the above two reasons, Unpaywall is, thus, only partly useful to determine immediate open access to individual articles in subscription-based journals.
...
### Variety of hybrid open access publishing
