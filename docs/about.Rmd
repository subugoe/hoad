...
Surprisingly, the hybrid open access market share of the top three publishers – Elsevier BV, Springer Nature and Wiley – is much larger than that of the total market in terms of published articles [@Larivi_re_2015]. Moreover, related studies observed higher uptake levels. Studying subscription-based journals with at least one identified hybrid open access article as well, @Laakso_2016 determined an open access share of 3.8 % for the period of 2011–2013. @Piwowar_2017, estimated an even higher proportion according to which 9.4 % of articles published in 2015 were provided open access with license statements, with or without delay, by non-DOAJ indexed journals.

The proposed journal selection criteria used have some limitations that likely explain these suprising results. First, it needs to be taken into consideration when interpreting the results that only one out of three publishers, where a research institution or a funder has demonstrably sponsored a hybrid open access article, shares licensing metadata through Crossref. Particularly, smaller publishing houses are not well represented in the sample, presumably because they lack resources to implement compliant metadata workflows. @Piwowar_2017 confirms that Crossref metadata in general lacks some license coverage. Therefore, they investigated publisher websites for license statements as well. Furthermore, @Piwowar_2017 observed that the percentage of open access provided by publishers, which was free to read, but where the journal was neither listed in the DOAJ nor provided licensing metadata, which they refer to as "bronze open access", was the most common method to provide open access among publishers. 

Second, there is a gap between spending information available through the Open APC initiative and the total number of hybrid open access articles published. One possible explanation is that reporting to the Open APC initiative is voluntary [@Jahn_2016]. Another that despite its international focus, most spending information in Open APC originated from European institutions, in particular from the UK [@Pieper_2018]. However, the analysis of email domains from corresponding authors, who published hybrid open access articles, illustrates that authors from the US, Germany and Japan ranked in the top 10.  Similarly, the Open APC Initiative has begun to disclose articles from transformative agreements with a strong focus on Springer Compact [@Pieper_2018]. But, as the example of the Sponsoring Consortium for Open Access Publishing in Particle Physic -- SCOAP$^3$, who uses an open access repository to share sponsored articles, demonstrates, the Open APC initiative does not track all transformative activities (yet).
Because of lacking spending data, it remains open to speculation whether authors can make use of institutional support not tracked by the Open APC initiative, or have accesss to other budgets to fund open access publication. Hybrid open access journals could also waive publication fees [@Solomon_2011] or make articles open for promotional reasons [@Laakso_2016]. 
